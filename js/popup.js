...
function f1(val) {
    ...
    document.getElementById('lang').style.color = val
...
function popup3_close() {
    document.getElementById('popup_setting3').style.display = 'none'
}
...
function popup1_open3() {
    document.getElementById('popup_setting3').style.display = 'block'
